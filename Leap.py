...
class Matrix(_object):
    ...
    if _newclass:
        x_basis = _swig_property(
            LeapPython.Matrix_x_basis_get, LeapPython.Matrix_x_basis_set
        )
    __swig_setmethods__["y_basis"] = LeapPython.Matrix_y_basis_set
    __swig_getmethods__["y_basis"] = LeapPython.Matrix_y_basis_get
    if _newclass:
        y_basis = _swig_property(
            LeapPython.Matrix_y_basis_get, LeapPython.Matrix_y_basis_set
        )
    __swig_setmethods__["z_basis"] = LeapPython.Matrix_z_basis_set
    __swig_getmethods__["z_basis"] = LeapPython.Matrix_z_basis_get
    if _newclass:
        z_basis = _swig_property(
            LeapPython.Matrix_z_basis_get, LeapPython.Matrix_z_basis_set
        )
    ...
    if _newclass:
        origin = _swig_property(
            LeapPython.Matrix_origin_get, LeapPython.Matrix_origin_set
        )
...
class Pointable(Interface):
    ...
    ] = LeapPython.Pointable_stabilized_tip_position_get
    if _newclass:
        stabilized_tip_position = _swig_property(
            LeapPython.Pointable_stabilized_tip_position_get
        )
...
class Hand(Interface):
    ...
    ] = LeapPython.Hand_stabilized_palm_position_get
    if _newclass:
        stabilized_palm_position = _swig_property(
            LeapPython.Hand_stabilized_palm_position_get
        )
...
class ScreenTapGesture(Gesture):
    ...
    for _s in [Gesture]:
        __swig_setmethods__.update(getattr(_s, "__swig_setmethods__", {}))
    __setattr__ = lambda self, name, value: _swig_setattr(
        self, ScreenTapGesture, name, value
    )
    __swig_getmethods__ = {}
    for _s in [Gesture]:
        __swig_getmethods__.update(getattr(_s, "__swig_getmethods__", {}))
...
class Device(Interface):
    ...
    ] = LeapPython.Device_horizontal_view_angle_get
    if _newclass:
        horizontal_view_angle = _swig_property(
            LeapPython.Device_horizontal_view_angle_get
        )
    __swig_getmethods__[
        "vertical_view_angle"
    ] = LeapPython.Device_vertical_view_angle_get
    if _newclass:
...
class Image(Interface):
    ...
    if _newclass:
        data = _swig_property(data)
    __swig_getmethods__["distortion"] = distortion
    if _newclass:
        distortion = _swig_property(distortion)
...
class InteractionBox(Interface):
    ...
    for _s in [Interface]:
        __swig_setmethods__.update(getattr(_s, "__swig_setmethods__", {}))
    __setattr__ = lambda self, name, value: _swig_setattr(
        self, InteractionBox, name, value
    )
    __swig_getmethods__ = {}
    for _s in [Interface]:
        __swig_getmethods__.update(getattr(_s, "__swig_getmethods__", {}))
...
class Frame(Interface):
    ...
    ] = LeapPython.Frame_current_frames_per_second_get
    if _newclass:
        current_frames_per_second = _swig_property(
            LeapPython.Frame_current_frames_per_second_get
        )
    ...
    if _newclass:
        serialize = _swig_property(serialize)
